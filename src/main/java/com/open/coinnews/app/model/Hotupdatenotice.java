 ...
 */
@Entity
@Table(name="t_hotupdatenotice")
public class Hotupdatenotice {
    @Id
    ...
    private String updatestrategyStr;
    ...
    public String getUpdatestrategyStr() {
        return updatestrategyStr;
    }

    public void setUpdatestrategyStr(String updatestrategyStr) {
        this.updatestrategyStr = updatestrategyStr;
    }
